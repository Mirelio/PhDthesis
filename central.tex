...
\input{chapterModelling/introduction}
\input{chapterModelling/methods}
\input{chapterModelling/results}
\input{chapterModelling/Lu_switches/lu_switches_summary}
\input{chapterModelling/mass_action_stochastic_switches/Stochastic_mass_action_switch_summary}
\input{chapterModelling/discussion}
%%-------------------------------------------------------------%%

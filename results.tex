...
\begin{equation}\dot{x}=f_{x}(x,y)=g_{x}H^{S}_{xy}(y)H^{S}_{xx}(x)-k_{x}x,\label{eq:lu_both_1}\end{equation}
...
\begin{figure}[p]
\centering
\includegraphics[scale=0.8]{images/Lu/posterior_100p_narrow.pdf}
...
\begin{figure}[p]
\centering
\includegraphics[scale=0.3]{images/Lu/tri/posterior_1000p_1.pdf}
...
\end{array}
$$
\paragraph{Double positive autoregulation:}
$$
\begin{array}{cccc} 
...
\begin{figure}[p]
\centering
\includegraphics[scale=0.7]{images/posterior_ma_dp_bi.pdf}
\caption{}
\label{fig:doub_pos}
\end{figure}
...
%\begin{figure}[ht!]
%\centering
%\includegraphics[scale=0.7]{images/Gardner/Stoch/posterior_100p.pdf}
%\caption{}
%\label{fig:stch_gard}
%\end{figure}
%
...
%\begin{figure}[ht!]
%\centering
%\includegraphics[scale=0.4]{images/Gardner/Stoch/phase_plots.png}

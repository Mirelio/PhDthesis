...
\begin{figure*}[b]
\begin{center}
\includegraphics[scale=0.5]{chapterModelling/mass_action_stochastic_switches/bi_tri_same_priors/posterior_pos_ab_bi.pdf}
...
\begin{figure*}b]
\begin{center}
\includegraphics[scale=0.5]{chapterModelling/mass_action_stochastic_switches/bi_tri_same_priors/posterior_pos_ab_tri.pdf}

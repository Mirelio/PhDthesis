...
% 	\EndIf
	...
	\State Initialise ε
	\Let{population p}{1}
	\Let{beta}{each stochastic trajectory}
	\If{p $= 1$}
...
GFP promoter leakiness & KL\textsubscript{u} & molecules h\textsuperscript{−1} & 1 - 50 & 1 - 50 \\
...
mCherry promoter leakiness & KL\textsubscript{v} &  molecules h\textsuperscript{−1} & 1 - 50 & 1 - 50 \\
...
\begin{figure}[tb]
\centerfloat
	\includegraphics[width=1.2\textwidth]{../../chapters/chapterABCFlow/images/2D_real_res.pdf}
...
\begin{figure}[htbp]
\centerfloat%
	\includegraphics[width=1.2\textwidth]{../../chapters/chapterABCFlow/images/2D_real_res_IPTG.pdf}

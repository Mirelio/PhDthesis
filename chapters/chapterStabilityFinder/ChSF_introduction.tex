...
As discussed in Section~\ref{sec:rob_back}, two models can be compared for their robustness using the Bayes factor, defined as follows:
...
\section{Discussion}
 ...
 %This is critical to the design of novel synthetic switches, where the stability of a system has to be well defined and predictable.
  A bistable, a tristable or a quadristable switch could each be used for different functions within a synthetic system. 

...
The phase plots of the Lu switch and the characterisation of their steady states shown in Figure~\ref{fig:lu_bifurc} was carried out by Mae Woods, PhD.
...
\label{alg:StabilityFinder}
 \begin{algorithmic}[1]
	...
	\State $w_{t}^{(i)} = \begin{cases} 1, & \mbox{if } t = 1 \\\frac{\pi(\theta_{t}^{(i)})}{\sum_{j=1}^N w_{t-1}^{(j)} K_{t}(\theta_{t-1}^{(j)}, \theta_{t}^{(i)})}, & \mbox{if } t \geq  1. \end{cases}$
...
\begin{figure*}[p]
\begin{center}
\includegraphics[width=\textwidth]{../../chapters/chapterStabilityFinder/images/ex1_sum.pdf}
...
\begin{figure*}[p]
\begin{center}
\includegraphics[width=\textwidth]{../../chapters/chapterStabilityFinder/images/ex4_summ.pdf}
...
μM time\textsuperscript{-1}&μΜ\textsuperscript{-1} time\textsuperscript{-1}&μM time\textsuperscript{-1}&μM\textsuperscript{-1} time\textsuperscript{-1}&(μM)&(μM)\\\bottomrule
\end{tabular}
\end{table}
...
\begin{figure*}[htbp]
\begin{center}
	\includegraphics[scale=0.8]{../../chapters/chapterStabilityFinder/images/gardner_poster.pdf}
...
\multirow{2}{4cm}{Degradation rate (Minute\textsubscript{-1})}               & kx        & 0-0.5   & 50-55     & 0-1      \\
...
\begin{figure*}[htbp]
	\centerfloat
		...
		\caption[ Design principles of multistable switches]{ \label{fig:lu_234}Design principles of multistable switches. (A) Using the Lu model with added positive autoregulation we uncover the design principles dictating if a switch will be bistable, tristable, or will have 4 steady states. (B-D) By considering the bivariate distributions of the parameters we can uncover the differences in the parameters of a bistable switch compared to a tristable switch, compared to a quadristable switch . The posterior distribution of the bistable switch is shown in blue, of the tristable switch in red and of a quadristable in green. The bivariate distributions for which a difference is observed between the stabilities are in black boxes. An example of a phase plot from each behaviour is shown next to the corresponding posterior distribution.}
\end{figure*}
...
\begin{array}{cccc}
      ...
      \textrm{A} + \textrm{A} \stackrel{\textrm{dim}}{\longrightarrow}\textrm{A\textsubscript{2}} \\
      \textrm{A\textsubscript{2}} \stackrel{\textrm{dim r}}{\longrightarrow}\textrm{A} + \textrm{A} \\
      ...
      \textrm{gA} + \textrm{B\textsubscript{2}} \stackrel{\textrm{repA}}{\longrightarrow}\textrm{B\textsubscript{2}gA} \\
      \textrm{B\textsubscript{2}gA} \stackrel{\textrm{rep\_r}}{\longrightarrow}\textrm{B\textsubscript{2}} + \textrm{gA} \\
      \textrm{gB} + \textrm{A\textsubscript{2}} \stackrel{\textrm{repB}}{\longrightarrow}\textrm{A\textsubscript{2}gB} \\
      ...
      \textrm{A\textsubscript{2}} \stackrel{\textrm{deg\_dim}}{\longrightarrow} \varnothing\\
      \textrm{B\textsubscript{2}} \stackrel{\textrm{deg\_dim}}{\longrightarrow}\varnothing\\
\end{array}
$$
...
$$
\begin{array}{cccc} 
    \textrm{A\textsubscript{2}} + \textrm{gA} \stackrel{\textrm{aut\_1}}{\longrightarrow} \textrm{A\textsubscript{2}gA} \\
    \textrm{A\textsubscript{2}gA} \stackrel{\textrm{aut\_2}}{\longrightarrow} \textrm{A} + \textrm{A\textsubscript{2}gA}\\
    \textrm{A\textsubscript{2}gA} \stackrel{\textrm{aut\_3}}{\longrightarrow} \textrm{A\textsubscript{2}}+ \textrm{gA}  \\
    \textrm{B\textsubscript{2}} + \textrm{gB} \stackrel{\textrm{aut\_1}}{\longrightarrow} \textrm{B\textsubscript{2}gB} \\
    \textrm{B\textsubscript{2}gB} \stackrel{\textrm{aut\_2}}{\longrightarrow} \textrm{B} + \textrm{B\textsubscript{2}gB}\\
    \textrm{B\textsubscript{2}gB} \stackrel{\textrm{aut\_3}}{\longrightarrow} \textrm{B\textsubscript{2}}+ \textrm{gB}  \\
\end{array}
$$
...
\begin{figure*}[htbp]
\begin{center}
\includegraphics[scale=0.7]{../../chapters/chapterStabilityFinder/images/MA-cs-dp-phase.pdf}
...
\begin{figure*}[h]
\begin{center}
\includegraphics[scale=0.7]{../../chapters/chapterStabilityFinder/images/priors_matter_2.pdf}

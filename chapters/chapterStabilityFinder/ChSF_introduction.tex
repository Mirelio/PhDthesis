...
\toprule
\multicolumn{4}{c}{Parameters}                          & \multicolumn{2}{c}{Species (μM)} \\ \cmidrule(lr){1-4}
\cmidrule(lr){5-6}

$a_1$ & $\beta$ & $a_2$ & \multicolumn{1}{c}{$\gamma$} & $s_1$        & $s_2$        \\
0-60  & 0-5     & 0-60  & 0-5                           & 0-100        & 0-100        \\ 
time\textsuperscript{-1}&μΜ\textsuperscript{-1} time\textsuperscript{-1}&time\textsuperscript{-1}&μM\textsuperscript{-1} time\textsuperscript{-1}&&\\\bottomrule
\end{tabular}
\end{table}
...
\begin{array}{cccc}
      ...
      \textrm{B\textsubscript{2}gA} \stackrel{\textrm{rep\_r}}{\longrightarrow}\textrm{B} + \textrm{gA} \\

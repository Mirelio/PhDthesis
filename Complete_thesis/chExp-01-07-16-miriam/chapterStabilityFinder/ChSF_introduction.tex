...
\begin{figure*}[p]
\begin{center}
\includegraphics[width=\textwidth]{chapterStabilityFinder/images/lu_paper_phase.png}
...
\begin{figure*}[p]
\begin{center}
\includegraphics[scale=0.6]{chapterStabilityFinder/images/lu_paper_post.png}
...
We find that the switch with single positive autoregulation is capable of bistable behaviour as seen in Figure~\ref{lu_paper_phase.png}B, but this is only possible when the strength of the promoter under positive autoregulation, $gx$, is small (\ref{fig:fig3}). There appear to be no such constraints on the strength of the original, unmodified, promoter, $gy$.  
...
\begin{figure*}[htbp]
\begin{center}
\includegraphics[width=\textwidth]{chapterStabilityFinder/images/MA_stoch_design_princ.png}
...
\begin{figure*}[h]
\begin{center}
\includegraphics[scale=0.8]{chapterStabilityFinder/images/priors_matter_2.png}

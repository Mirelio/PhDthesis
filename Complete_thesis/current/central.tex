...
Here, the genetic toggle switch was studied computationally and experimentally. Bayesian methods were used to compare competing model designs of the genetic toggle switch. The method used enables the simultaneous inference of the kinetic parameters and the ranking of the models with respect to robustness. 

A computational tool based on Bayesian statistics was developed, that can identify regions of parameter space capable of producing multistable behaviour, while handling uncertainty in biochemical rate constants and initial conditions. A collection of models of genetic switches were examined, ranging from the deterministic simplified toggle switch to stochastic models containing different positive feedback connections. The design principles behind making a bistable switch were uncovered, as well as those necessary to make a tristable or quadristable switch.

Flow Cytometry was used to characterise a known toggle switch plasmid. A computational tool were developed which takes advantage of sequential Monte Carlo methods to infer model parameter values from flow cytometry data. ABC-Flow was used to characterise the toggle switch plasmid and fit models to experimental results. 

These results, taken together, suggest many ways in which the construction of genetic switches can be enhanced. A design strategy is presented for the construction of novel toggle switches.
\end{abstract}
